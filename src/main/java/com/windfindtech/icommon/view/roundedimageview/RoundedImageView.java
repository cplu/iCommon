...
import com.windfindtech.icommon.view.FixedRatioImageView;

/**
 * Created by py on 2016/3/22.
 */
public class RoundedImageView extends FixedRatioImageView {
...
//        m_widthRatio = a.getInteger(R.styleable.RoundedImageView_round_widthRatio, 1);
//        m_heightRatio = a.getInteger(R.styleable.RoundedImageView_round_heightRatio, 1);
//        m_fixedSide = a.getInteger(R.styleable.RoundedImageView_round_fixedSide, SIDE_WIDTH);
...
//    @Override
//    protected vd onMeasure(inwidthMeasureSpec, int heightMeasureSpec) {
//        if(m_fixedSide == SIDE_DTH) {
//            int width = getMeasedWidth();
//            int height = width m_heightRatio / m_widthRatio;
//            int heightSpec = MeureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY);
//            super.onMeasure(widMeasureSpec, heightSpec);
//        }
//        else{
//          inteight = getMearedHeight();
//            int width = height m_widthRatio / m_heightRatio;
//            int widthSpec = MeareSpec.makeMeasureSpec(width, MeasureSpec.EXACTLY);
//            super.onMeasure(widSpec, heightMeasureSpec);
//        }
//    }
//
//    publ void prepeAspecao(int widthRatio, int heightRatio){
//        m_widthRatio = widthRat;
//        m_heightRatio = heightRio;
//    }
//
//    /**
//     * sethe fix de of thlayout
//     * @param side      should  one of SIDE_WIDTH/SIDE_HEIGHT
//     */
//    public void setFidSide(inside){
//        m_fixedSide = side;
//  }
}
