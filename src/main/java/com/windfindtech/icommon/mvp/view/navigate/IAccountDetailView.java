 ...
 */
public interface IAccountDetailView extends INavigateView{

	IAccountDetailView dummy = new IAccountDetailView() {
	...
	void onUpdateAccountInfoFailed(WSErrorResponse reason);

	void onUpdateAccountInfoSuccess(int position, UserData userData);
}
